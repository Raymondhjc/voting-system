...
class AuthenticationServiceStub {
  ...
  pushUsername(value: UserStatusModel) {
...
describe('lverg:HeaderComponent', () => {
  ...
  it('should display correct name after logged in', () => {
    ...
    fixture.detectChanges();
    const userStatus = new UserStatusModel('testFirstname', 'testlastname', 'testUsername', 'testPassword', '12345678', 'user');
    authenService.pushUsername(userStatus);
    fixture.detectChanges();
    ...
    expect(el.innerText).toContain('testUsername');
  });
});
